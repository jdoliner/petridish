...
urlpatterns = patterns('',
	...
	(r'^dish/(?P<d_id>\d+)/properties/$', 'petridish.dish.views.properties'),
	...
	(r'^dish/(?P<d_id>\d+)/go/$', 'petridish.dish.views.go'),
	(r'^dish/(?P<d_id>\d+)/register/', 'petridish.evolver.views.register'),
